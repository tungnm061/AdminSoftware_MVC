...
namespace Core.Data
{
    public class FastADOProvider : IDisposable
    {
        ...
        public IDbConnection Connection
        {
            get
            {
                ...
                return new SqlConnection(DataHelper.GetFastAccoutingConnectionString());
            }
        }
        ...
        /// <param name="schema">The schema.</param>
        /// <returns></returns>
        public FastADOProvider(string schema)
        {
            _schema = schema;
        }
