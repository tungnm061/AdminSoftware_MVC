...
function OpenDetail(id) {
    $("#UserId").val(id);
    InitWindowModal('/hrm/StatisticalSuggesDepartment/SuggesWorkDetail',false, 1000, 500, "Công việc đề xuất",false);
}
        ...
        var newDataSource = new kendo.data.DataSource({
            transport: {
                read: function (options) {
                    ...
                    {
                        type: 'POST',
                        url: '/hrm/StatisticalSuggesDepartment/SuggesWorks',
                        dataType: "json",
                        data: JSON.stringify({
                            fromDate: fromDate,
                            toDate: toDate
