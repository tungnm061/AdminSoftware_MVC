...
$(document).ready(function () {
    ...
    $("#ModalTaskId").click(function () {
        InitChildWindowModal('/sale/Home/TaskSearch', 800, 520, "Danh sách công việc");
    });
    $("#ModalEmployeeId").click(function () {
        var action = '3';
        InitChildWindowModal('/sale/Home/Employees?id=' + action, 800, 550, "Tìm kiếm nhân viên");
    });
