...
$(document).ready(function () {
    ...
    $('#btnCreate').click(function () {
        InitWindowModal('/system/Account/Account', false, 800, 300, 'Thêm mới tài khoản', false);
    });
    $('#btnEdit').click(function () {
        ...
        InitWindowModal('/system/Account/Account?id=' + id, false, 800, 300, 'Cập nhật tài khoản', false);
    });
