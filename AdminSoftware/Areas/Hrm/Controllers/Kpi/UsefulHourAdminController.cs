...
namespace AdminSoftware.Areas.Hrm.Controllers.Kpi
{
    public class UsefulHourAdminController : BaseController
    {
        ...
        public JsonResult EmployeeUsefulHours(DateTime? fromDate, DateTime? toDate, long? departmentId)
        {
            return Json(_workDetailBll.GetEmployeeUsefulHours(fromDate, toDate, departmentId));
        }
