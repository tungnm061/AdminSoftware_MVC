...
{
    public class StatisticalComplainDepartmentController : BaseController
    {
        ...
        public StatisticalComplainDepartmentController()
        {
        ...
        public JsonResult StatisticalComplains(DateTime? fromDate, DateTime? toDate)
        {
