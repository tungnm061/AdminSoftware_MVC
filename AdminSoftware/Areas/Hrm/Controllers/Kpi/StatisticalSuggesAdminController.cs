...
{
    public class StatisticalSuggesAdminController : BaseController
    {
        private readonly DepartmentBll _departmentBll;
        private readonly WorkDetailBll _workDetailBll;

        public StatisticalSuggesAdminController()
        {
        ...
        public JsonResult SuggesWorks(DateTime? fromDate, DateTime? toDate, long? departmentId)
        {
