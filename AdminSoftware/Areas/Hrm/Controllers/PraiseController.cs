...
namespace AdminSoftware.Areas.Hrm.Controllers
{
    public class PraiseController : BaseController
    {
        ...
        public JsonResult Praises()
        {
            var praiseDisciplines = _praiseDisciplineBll.GetPraiseDisciplines((byte) PraiseDisciplineType.Praise);
        ...
        public JsonResult PraiseDetails()
        {
