...
function OpenDetail(id) {
    $("#UserId").val(id);
    InitWindowModal('/hrm/StatisticalComplainAdmin/ComplainDetail', false, 1000, 500, "Danh sách phản ánh", false);
}
        ...
        var newDataSource = new kendo.data.DataSource({
            transport: {
                read: function (options) {
                    ...
                    {
                        type: 'POST',
                        url: '/hrm/StatisticalComplainAdmin/StatisticalComplains',
                        dataType: "json",
                        data: JSON.stringify({
                            fromDate: fromDate,
                            toDate: toDate,
