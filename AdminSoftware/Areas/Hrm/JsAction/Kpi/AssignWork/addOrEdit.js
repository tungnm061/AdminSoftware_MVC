...
$(document).ready(function () {
    ...
    $("#ModalTaskId").click(function () {
        InitChildWindowModal('/hrm/AssignWork/Tasks', 800, 520, "Danh sách công việc");
    });
    $("#ModalEmployeeId").click(function () {
        var action = '3';
        //var action = $("#TypeAssignWork").data("kendoDropDownList").value();
        //if (action === "") {
        //    $.msgBox({
        //        title: "Hệ thống",
        //        type: "error",
        ...
        //    return;
        //}
        InitChildWindowModal('/hrm/AssignWork/Employees?id=' + action, 800, 550, "Tìm kiếm nhân viên");
    });
