...
$(document).ready(function () {
    ...
    $('#btnCreateWorkingNote').click(function () {
        InitChildWindowModal('/hrm/Home/WorkingNote', 550, 330, "Thêm tiến độ thực hiện công việc");
    });
    ...
    $('#btnEditWorkingNote').click(function () {
        ...
        InitChildWindowModal('/hrm/Home/WorkingNote?id=' + id, 550, 330, "Cập nhật tiến độ thực hiện công việc");
    });
    $('#btnDeleteWorkingNote').click(function () {
        ...
        if (id != null && id != typeof undefined) {
            ...
            $.ajax({
                type: 'POST',
                url: '/hrm/Home/DeleteWorkingNote',
                dataType: "json",
                data: JSON.stringify({
                    id: id
                }),
    ...
    $("#btnSaveAdd").click(function () {
        ...
        if (status === '5' && ($("#Explanation").val() == null || $("#Explanation").val().trim() === "")) {
            InitChildWindowModal('/hrm/Home/Explanation', 600, 300, 'Giải trình công việc');
            return;
        }
