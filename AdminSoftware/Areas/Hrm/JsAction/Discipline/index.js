...
$(document).ready(function () {
    ...
    $('#btnCreate').bind("click", function () {
        InitWindowModal('/hrm/Discipline/Discipline', false, 800, 520, "Thêm mới kỷ luật", false);
    });
    $('#btnEdit').bind("click", function () {
        ...
        InitWindowModal('/hrm/Discipline/Discipline?id=' + id, false, 800, 520, "Cập nhật kỷ luật", false);
    });
    $("#grdMain").kendoGrid({
        dataSource: {
            transport: {
                read: '/hrm/Discipline/Disciplines',
                dataType: "json"
            },
            schema: {
                model: {
