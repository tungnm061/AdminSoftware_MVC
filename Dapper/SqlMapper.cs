...
Type type, IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
        ...
        public partial class GridReader : IDisposable
        {
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(object func, string splitOn)
            {
                ...
                try
                {
                    foreach (var r in MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, null, func, null, null, splitOn, null, null, reader, identity))
                    {
                        yield return r;
                    }
                }
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters
    {
        ...
        /// </value>
        public bool UseCache => ConfigurationManager.AppSettings["UseCache"].ToLower() == "true";
